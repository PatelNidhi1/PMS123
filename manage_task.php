...
<div class="container-fluid">
	<form action="" id="manage-task">
		...
		<div class="form-group">
			...
			<textarea name="description" id="des" cols="30" rows="7"  required class="summernote form-control"><?php echo isset($description) ? $description : '' ?></textarea>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control form-control-sm" name="milestone" value="<?php echo isset($milestone) ? $milestone : '' ?>" required>
		</div>	
		<div class="form-group">
              <label for="" class="control-label">Deadline</label>
              <input type="date" class="form-control form-control-sm" autocomplete="off" name="deadline" value="<?php echo isset($deadline) ? date("Y-m-d",strtotime($deadline)) : '' ?>" required>
            </div>			
		<hr>
