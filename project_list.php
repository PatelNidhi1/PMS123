			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<?php
					...
					<tr>
						...
						<td class="click"><b><?php echo date("M d, Y",strtotime($row['start_date'])) ?></b></td>
						<td class="click"><b><?php echo date("M d, Y",strtotime($row['end_date'])) ?></b></td>
...
<script>	
	$('table tbody tr td').not(":first-child").not(":nth-last-child(2)").click(function(){		
		var id = $(this).closest('tr').find('td:eq(5)').text();
		window.location.href = "./index.php?page=view_project&id=" + id
        return false;				
	})
